...
def known_parcel_id(base_url: str) -> str:
    """Pull a real parcel ID off the insights dashboard for detail-page tests.
...
def reset_rate_limit():
    ...
    if not db_url:
        pytest.skip('E2E_DATABASE_URL not set — cannot reset rate-limit cache between tests')
    import psycopg2
