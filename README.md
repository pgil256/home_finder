...
- **No Google or paid API dependency.** Search and analytics use the county's public dataset, parcel photos come directly from the Property Appraiser when available, maps open in OpenStreetMap, and the interface uses system fonts and bundled SVG icons.
